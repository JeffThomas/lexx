...
mod tests {
    ...
    use crate::matcher::matchers::keyword_matcher::KeywordMatcher;
    use crate::matcher::matchers::whitespace_matcher::WhitespaceMatcher;
    use crate::util::token::TOKEN_TYPE_KEYWORD;
    use crate::Lexx;
    ...
    fn exact_matcher_matches_word() {
        let mut lexx = Lexx::<512>::new(
            ...
            vec![Box::new(KeywordMatcher::build_keyword_matcher(
                vec!["The"],
                TOKEN_TYPE_KEYWORD,
                0,
            ))],
    ...
    fn exact_matcher_matches_multiple_words() {
        ...
        let mut lexx = Lexx::<512>::new(
            ...
            vec![
                Box::new(KeywordMatcher::build_keyword_matcher(
    ...
    #[test]
    fn exact_matcher_does_not_match_partial_word() {
        let mut lexx = Lexx::<512>::new(
